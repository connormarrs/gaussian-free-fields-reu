...
fileNames="../src/DFGF_S1.cpp ../src/DFGF_T2.cpp ../src/driver_S1.cpp ../src/RandVec.cpp ../src/RandArr.cpp ../src/tools.cpp" 

# binaryName="~/gaussian-free-fields/simulations/build/run_driver_S1"
cd simulations/build/

g++ -std=c++11 -pthread -static-libstdc++ -Wall $fileNames -o run_driver_S1 && echo "compilation successful"
