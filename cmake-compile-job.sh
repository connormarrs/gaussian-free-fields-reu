...
# fileNames="./simulations/src/DFGF_S1.cpp ./simulations/src/DFGF_T2.cpp ./simulations/src/driver.cpp ./simulations/src/RandVec.cpp ./simulations/src/RandArr.cpp ./simulations/src/tools.cpp" 

# g++ -std=c++11 -pthread -static-libstdc++ -Wall $fileNames -o run_driver
